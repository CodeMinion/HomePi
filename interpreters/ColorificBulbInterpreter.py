...
# Implemetation of the interpreter to
# handle communication with a Colorific
# light bulb. This turns higher levle 
# commands applicable to all light bubls
# into low level commands understood by
# the Colorific lighbulb. 
...
class ColorificBulbInterpreter(object):
	...
	# result. Usuful for knowing the when bulb
	# has disconnected.
	...
	def receiveData(self):
		...
		data = ''
		return
	# Helper function to build a command to send.	
